...
public enum ErrorCode {
    ...
    ERR_REGISTRATION_TOKEN_NOT_FOUND("Token %s was not found!"),
    ...
    ERR_ROLE_MUST_BE_TEAM_LEADER("Role must be team leader role!"),
    ...
    ERR_USER_UNAUTHORIZED("Authentication is required to access this resource."),
