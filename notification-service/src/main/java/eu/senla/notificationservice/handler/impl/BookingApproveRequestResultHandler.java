...
@Component
public class BookingApproveRequestResultHandler extends MailTypeHandlerImpl {

    @Autowired
    public BookingApproveRequestResultHandler(EmailService emailService) {
        super(emailService);
    }
    ...
    public MailType getMailType() {
        return MailType.BOOKING_APPROVE_REQUEST_RESULT_MAIL;
    }
}
